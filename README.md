...
<!-- File transfer tool -->
  <li>
    ...
    <p>This is a companion app for the <a style="color:#b5e853; text-decoration: none;" href='https://github.com/leolion3/Portfolio/tree/master/Python/FileSender' target='_blank'>Python File Transfer Tool</a> found <a style="color:#b5e853; text-decoration: none;" href="#file-transfer-ref">above</a>. A Java graphical variant is pending release and will soon be available on Github!</p>
  </li>
<!-- Sharky -->
  <li>
    <h2>
